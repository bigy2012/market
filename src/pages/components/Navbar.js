...
const Navbar = () => {
  ...
  return (
    <div className="py-2 px-4 bg-base-100 shadow-md flex justify-between items-center top-0 sticky z-50">
      <div className="flex items-center gap-2">
        <BsFacebook className="text-primary bg-white rounded-full p-0 border border-primary text-[40px]" />
        {/* <h1 className="font-medium">Smileroom</h1> */}
